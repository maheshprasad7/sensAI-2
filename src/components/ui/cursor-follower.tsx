...
export const Component = () => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[9999]">
      ...
      <div
        className="absolute rounded-full border border-white/60 bg-white/5 backdrop-blur-[1px] shadow-[0_0_12px_rgba(255,255,255,0.2)] md:block hidden"
        style={{
          ...
          borderColor: isHovering ? "rgba(255, 204, 0, 0.8)" : "rgba(255, 255, 255, 0.6)",
        }}
      />
    </div>
  );
...
export { Component as CursorFollower };
